class OperationsController < ApplicationController
  ...
  #  @operations = Operation.find(:all, :conditions=>"user_id="+user_id.to_s)
    @operations = Operation.paginate(:all, :conditions=>"user_id="+user_id.to_s, :page=> params[:page],:per_page => 20)
